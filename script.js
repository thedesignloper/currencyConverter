...
countries.forEach((country)=>{
    ...
    option1.value=option2.value=country.cc;
    option1.textContent=option2.textContent=`${country.cc} (${country.name})`  
...
const getExchangeRate = async ()=>{
   ...
   try{
        ...
        if(typeof conversionRate==='undefined'){
            resultElement.textContent="Exchange rate data is not available for the selected";
        ...
        containerElement.innerHTML = `<h3>Error while fetching exchange rates!!!</h3>`
    }
